...
export const Auth =({type}: {type: "signin" |"signup"}) =>{
    const navigate = useNavigate();//note this hook must be called inside a function component compulsorily
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            ...
            <div className="pt-4">
                {type ==="signup" ?  <LabelledInput label="Name" placeholder="skandesh.." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
